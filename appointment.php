...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"insert into tblappointment(Name,Email,PhoneNumber,AptDate,AptTime,Services,AptNumber) value('$name','$email','$phone','$adate','$atime','$services','$aptnumber')");
    if ($query) {
...
<head>
   <title>Cabinate salon || Appointments Form</title>
                            ...
                            <form method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="phone" name="phone" placeholder="Phone" required="true" maxlength="10" pattern="[0-9]+">
                                    </div>
                                    <div class="col-md-6">
